...
p1 <- channelActivityPlot(ucsc1b, select(rawData(ucsc1b), id, median_signal))
p2 <- plotKmerFrequencyCorrelation(ucsc1b) + scale_fill_gradient(high = "orange", low = "darkblue")
grid.arrange(p1, p2, ncol = 2)
